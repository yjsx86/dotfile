...
install_dependencies() {
    echo -e "\n${GREEN}====== 安装依赖 ======${NC}"
    DEPENDENCIES=(git zsh build-essential wtmpdb wget xz-utils fd-find ripgrep btop fzf tmux tree nmap iftop nethogs vnstat)
    MISSING_DEPS=()
...
alias myip='echo "IPv4: $(curl -s4 ipv4.icanhazip.com || echo "None")" && echo "IPv6: $(curl -s6 ipv6.icanhazip.com || echo "None")"'
